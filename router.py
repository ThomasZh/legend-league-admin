...
def map():
    ...
    config = [
        ...
        (r'/admin/todo-detail/edit', getattr(work_sheet, 'TodoDetailEditHandler')),
        ...
        (r'/admin/categories/suppliers', getattr(category, 'CategoriesSuppliersHandler')),
        (r'/admin/categories/supplier-tags', getattr(category, 'CategoriesSupplierTagsHandler')),
        (r'/admin/categories/tags/suppliers', getattr(category, 'CategoriesTagsSuppliersHandler')),
